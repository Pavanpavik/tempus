...
#searching for the attributes.
    ...
    name1=soup.find('div',attrs={'class':'cb-hmscg-bat-txt cb-ovr-flo '})
    name=name1.text     #sometimes .strip() is used
    
    name2=soup.find('div',attrs={'class':' cb-ovr-flo cb-text-live'})
    des=name2.text
    final=name+'\n'+des
    mes.showinfo('Current score',final)
...
filename = PhotoImage(file="C:\\Users\\Pavan\\AppData\\Local\\Programs\\Python\\Python36-32\\Tempus\\rainclock.png")
...
filename1 = PhotoImage(file="C:\\Users\\Pavan\\AppData\\Local\\Programs\\Python\\Python36-32\\Tempus\\rainclk3.png")
